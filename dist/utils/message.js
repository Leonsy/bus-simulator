...
var message = {
  ...
  avaliableCommand: 'Avaliable commands are PLACE X,Y,F | MOVE | LEFT | RIGHT | REPORT',
  placeCommand: 'Please PLACE the bus in the carpark in position X,Y and facing NORTH, SOUTH, EAST or WEST. (example: PLACE 0,0,NORTH)',
